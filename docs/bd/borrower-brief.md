...
Use the [worked example](worked-example.md) for the first walkthrough, then the [discovery
guide](discovery-guide.md) to record the borrower's actual hedge, funding and governance
requirements before anyone changes the example terms.
